...
const TreeSelectProperties = (props) => {
    ...
    return <FormPropertiesWrapper ref={wrapRef} {...props}>
        ...
        {/* 操作属性 */}
        <ActionProperties {...props} wrapRef={wrapRef} attrs={['hidden', 'disabled', 'clearable', 'multiple', 'showSearch', 'treeCheckable']} />
...
export default TreeSelectProperties;
